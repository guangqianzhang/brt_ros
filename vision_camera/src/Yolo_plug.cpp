#include <fstream>
#include "vision_camera/Yolo_plug.h"
...
cv::Mat Yolo_plug::detect(cv::Mat raw_img, std::vector<YoloDetSt> &yoloRet)
{
...
int Yolo_plug::runningYolo(cv::Mat &img, std::vector<YoloDetSt> &yoloRet)
{
...
void Yolo_plug::postprocess(cv::Mat &frame, const std::vector<cv::Mat> &outs, cv::dnn::Net &net, std::vector<YoloDetSt> &yoloRet)
{
...
void Yolo_plug::drowBoxes(cv::Mat &img, std::vector<YoloDetSt> &yoloRet)
{
