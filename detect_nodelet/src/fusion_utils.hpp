...
pcl::PointCloud<pcl::PointXYZ> Obj2PointCloud(rockauto_msgs::DetectedObject &objects)
{
...
pcl::PointCloud<pcl::PointXYZRGB> Obj2PointCloud(rockauto_msgs::DetectedObjectArray &objects_array)
{
...
void drawrectangleIOU(cv::Mat &img, cv::Rect rect, std::string label, double iou)
{
